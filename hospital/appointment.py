...
frame.place(x=0, y=90, width=1300, height=450)
Dataframeleft = LabelFrame(frame, text='Patient Information', bg='powder blue', fg='green', bd=12, relief=RIDGE,
                           font=("times new roman", 12, "bold"))
Dataframeleft.place(x=0, y=5, width=280, height=400)
Dataframeright1 = LabelFrame(frame, bg='powder blue', bd=12, relief=RIDGE, font=("times new roman", 12, "bold"))
Dataframeright1.place(x=300, y=5, width=600, height=400)
Dataframeright2 = LabelFrame(frame, text="Calendar", fg='green', bg='powder blue', bd=12, relief=RIDGE,
                             font=("times new roman", 12, "bold"))
Dataframeright2.place(x=750, y=5, width=500, height=400)
...
framedetails.place(x=0, y=590, width=1300, height=210)
framedetails1 = LabelFrame(framedetails, text="Calendar", bg='powder blue', fg='green', bd=12, relief=RIDGE,
                           font=("times new roman", 12, "bold"))
framedetails1.place(x=0, y=5, width=600, height=180)
framedetails2 = LabelFrame(framedetails, text="mm", bg='powder blue', fg='green', bd=12, relief=RIDGE,
                           font=("times new roman", 12, "bold"))
framedetails2.place(x=600, y=5, width=600, height=180)
FrameButton = Frame(root, bd=12, relief=RIDGE, padx=20, bg='powder blue')
FrameButton.place(x=0, y=530, width=1300, height=70)
myButton_label = Button(FrameButton, text="Only Use For Doctors", bg='grey', font=('calibri', 14,), width=20,
                        relief=SUNKEN)
...
symptom2_label = Label(Dataframeright1, text='Happining right now', font=('calibri', 14,), width=17, relief=SUNKEN)
...
exit_button = Button(Dataframeleft, text="EXIT", font=('calibri', 14,), width=22, bg='grey', relief=SUNKEN,
                     borderwidth=5)
...
logout_button = Button(Dataframeleft, text="LOG OUT", font=('calibri', 14,), width=22, bg='grey', relief=SUNKEN,
                       borderwidth=5)
logout_button.grid(row=6, columnspan=2)  # add yesandno message box for this
root.mainloop()
