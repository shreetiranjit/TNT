...
def prescribe1():
    ...
    frame_rec = LabelFrame(records_frame, text='records', font=('georgia', 12, 'bold'), relief=RIDGE, bd=5, fg="black", bg="white")
