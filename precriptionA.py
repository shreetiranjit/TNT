...
def prescribe1():
    ...
    records_frame.place(x=0, y=310, width=580, height=90)
    ...
    delete_btn.place(x=140, y=50)
    enter_btn = Button(root, text='ENTER', font=('calibre', 16, 'bold'), bg='red', fg='white', command=query)
    enter_btn.place(x=220, y=50)
    entry_btn = Button(root, text='Submit', font=('calibre', 16, 'bold'), bg='red', fg='white' ,command = submit )
    entry_btn.place(x=300, y=50 )
    clear_btn = Button(root, text='Clear', font=('calibre', 16, 'bold'), bg='red', fg='white',command = clear)
    clear_btn.place(x=480, y=50)
